...
- Le citoyen est en possession d'une arme illégale.

1.5) Les silencieux sont considéré illégal.

1.6) Un citoyen est dans l'obligation d'enregistrer les armes qu'il possède. Dans le cas où une arme n'est pas enregistré, il s'agit d'une possession d'arme illégale.
