...
5.2 Braquer les joueurs pour prendre le contenu de leur inventaire sans réel but précis n’est pas accepté. Si vous prenez les objets d’un autre il vous faut un motif raisonnable sauf sur un point chaud, car il s'agit d'endroits dangereux.
